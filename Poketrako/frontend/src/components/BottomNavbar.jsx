...
import { FiHome, FiArrowUpRight, FiArrowDownLeft, FiFolder, FiUser, FiCreditCard, FiClock, FiPackage } from 'react-icons/fi';
...
const BottomNavbar = () => {
  ...
  return (
    <div className="bottom-navbar">
      ...
      <NavLink to="/caisse" className={({ isActive }) => `bottom-nav-item ${isActive ? 'active' : ''}`}>
        <div className="bottom-nav-icon"><FiCreditCard /></div>
        <span className="bottom-nav-label">{t('caisse')}</span>
      </NavLink>
