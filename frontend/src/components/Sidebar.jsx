...
import { FiHome, FiArrowUpRight, FiArrowDownLeft, FiFolder, FiUser, FiLogOut, FiMenu, FiBriefcase, FiClock, FiPackage } from 'react-icons/fi';
  ...
  return (
    <div className={`sidebar ${open ? 'open' : 'collapsed'}`}>
      ...
      <nav>
        ...
        <NavLink to="/enterprise" className="fade-in-up stagger-4">
          <span className="sidebar-icon"><FiBriefcase /></span>
          <span className="sidebar-label">{t('enterprise')}</span>
        </NavLink>
